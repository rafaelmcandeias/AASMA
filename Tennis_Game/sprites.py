...
class Ball(pygame.sprite.Sprite):
    ...
    def update(self, bottom_player, top_player):
        ...
        if self.rect.colliderect(bottom_player) and self.rect.x > bottom_player.rect.x + 10 and 325 < bottom_player.rect.y < 450:
            bottom_player.image = images.robert_forehand_volley
            effect = pygame.mixer.Sound('tennisserve.wav')
            effect.play(0)
            bottom_player.rect.y -5
            self.speedy = -5
        ...
        if self.rect.colliderect(bottom_player) and self.rect.x < bottom_player.rect.x - 10 and 325 < bottom_player.rect.y < 450:
            bottom_player.image = images.robert_backhand_volley
            effect = pygame.mixer.Sound('tennisserve.wav')
            effect.play(0)
            bottom_player.rect.y -5
            self.speedy = -4.5
        ...
        if self.rect.colliderect(top_player) and self.rect.x < top_player.rect.x -10 and 200 < top_player.rect.y < 325:
            top_player.image = images.camden_forehand_volley
            effect = pygame.mixer.Sound('tennisserve.wav')
            effect.play(0)
            top_player.rect.y -5
            self.speedy = 3.75
        ...
        if self.rect.colliderect(top_player) and self.rect.x > top_player.rect.x + 10 and 200 < top_player.rect.y < 325:
            top_player.image = images.camden_backhand_volley
            effect = pygame.mixer.Sound('tennisserve.wav')
            effect.play(0)
            top_player.rect.y -5
            self.speedy = 3.75
